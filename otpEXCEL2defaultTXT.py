...
def extract_sheets_to_txt(input_excel, output_txt, start_sheet, end_sheet):
    ...
    with open(output_txt, 'w', encoding='utf-8') as f:
        ...
        for sheet in wb.worksheets[start_idx:end_idx+1]:
            line = "\nR9F " + f"{(wb.worksheets.index(sheet) - 5):02X}" + "\n"
            f.write(line)
...
# 使用示例
input_excel = "C:\\Users\\67064\\Desktop\\ICNA3508_Instruction_Table_OTP.xlsx"
output_txt = "C:\\Users\\67064\\Desktop\\output_3508_default.txt"
