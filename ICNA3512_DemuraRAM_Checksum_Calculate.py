...
# 调用函数，指定文件路径和行范围
# file_path = "C:\\Users\\67064\\Desktop\\NG_DATA1.txt"
file_path = "C:\\Users\\67064\\Desktop\\output.txt"
# file_path = "C:\\Users\\67064\\Desktop\\read-all-flash-ok.txt" # 要把前4096Byte数据去掉
start_line = 1  # 起始行
# end_line = 1325056  # 结束行
# end_line = 1324798  # 结束行
